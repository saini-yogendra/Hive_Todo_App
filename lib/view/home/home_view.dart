...
// import 'package:hiveapp/view/home/widgets/fab.dart';
// import 'package:lottie/lottie.dart';
//
// import '../../utils/strings.dart';
    ...
    return Scaffold(
      ...
      body: SliderDrawer(
        key: drawerKey,
          ...
          child: _buildHomeBody(textTheme, size),
      ),
    );
  }

  Widget _buildHomeBody(TextTheme textTheme, Size size) {
    return SafeArea(
      child: SizedBox(
        width: double.infinity,
        height: double.infinity,
